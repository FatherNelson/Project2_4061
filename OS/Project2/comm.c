...
{
	printf("connect to server was called\n");
	...
	printf("%s\n", addr.sun_path);
//	fcntl(server_fd, F_SETFL, fcntl(0, F_GETFL)| O_NONBLOCK); //This line makes the read call non-blocking
	...
	/** We get stuck in this code block for some reason **/
