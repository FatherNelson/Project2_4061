...
*     execute_command. Also did most of the work figuring out how to check
*     the timestamps of files, and how to check if a dependency has already been
*     built, and thus does not need to be built again.
*
...
*     function. Also tested the executable with the given tests to see whether
*     make4061 functions as intended in most if not all defined cases.
*/
